...
<template>
    <div class="col-lg-4" v-for="recentPost in recentPosts" :key="recentPosts.id">
                    <div class="card-style-1 hover-up mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                      <div class="card-image"><NuxtLink class="post-type" :to="`/blogs/${recentPost.id}`"></NuxtLink><NuxtLink class="link-post" :to="`/blogs/${recentPost.id}`"><img :src="getMedia(recentPost.image)" alt="Genz">
