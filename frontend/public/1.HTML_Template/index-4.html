              ...
              <div class="header-nav">
                <nav class="nav-main-menu d-none d-xl-block">
                  <ul class="main-menu">
                    ...
                    <li class="has-children"><a class="color-gray-500" href="#">Category</a>
                    ...
                    <li class="has-children"><a class="color-gray-500" href="#">Single Post</a>
                      <ul class="sub-menu two-col">
            ...
            <div class="col-xl-10 col-lg-12">
              <div class="pt-20">
                <div class="box-banner-4">
                  ...
                  <div class="banner-info"><span class="text-sm-bold color-gray-600">Hello Everyone!</span>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-10 col-lg-12">
              <div class="row mt-90 mb-50">
                <div class="col-lg-12">
                  <div class="box-list-posts">
                    <div class="row">
                      <div class="col-lg-7">
                        <div class="card-blog-1 card-blog-2 hover-up wow animate__animated animate__fadeIn" data-wow-delay="0">
                          <div class="card-image mb-20"><a class="post-type" href="#"></a><a href="single-sidebar.html"><img src="assets/imgs/page/homepage4/news1.png" alt="Genz"></a></div>
                          <div class="card-info"><a href="single-sidebar.html">
                              <h4 class="color-white mt-30">I work best when my space is filled with inspiration</h4></a>
                            <p class="mt-25 text-lg color-gray-700">Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped lynx far that and jeepers giggled far and far</p>
                      ...
                      <div class="col-lg-5">
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="card-list-posts card-list-posts-small mb-30 wow animate__animated animate__fadeIn" data-wow-delay="0.1s">
                              <div class="card-image hover-up"><a href="single-sidebar.html"><img src="assets/imgs/page/homepage4/img1.png" alt="Genz"></a></div>
                              <div class="card-info"><a class="btn btn-tag bg-gray-800 hover-up mb-10 text-xs" href="blog-archive.html">Working Tips</a><a href="single-sidebar.html">
                                  <h5 class="mb-10 color-white">10 States At Risk of Rural Hospital Closures</h5></a>
                                <div class="row mt-10">
                                  <div class="col-12"><span class="calendar-icon color-gray-700 text-sm mr-20">29 May 2022</span><span class="color-gray-700 text-sm timeread">3 mins read</span></div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="card-list-posts card-list-posts-small mb-30 wow animate__animated animate__fadeIn" data-wow-delay="0.2s">
                              <div class="card-image hover-up"><a href="single-sidebar.html"><img src="assets/imgs/page/homepage4/img2.png" alt="Genz"></a></div>
                              <div class="card-info"><a class="btn btn-tag bg-gray-800 hover-up mb-10 text-xs" href="blog-archive.html">Working Tips</a><a href="single-sidebar.html">
                                  <h5 class="mb-10 color-white">U.S. Interventions in Latin America, in Photos</h5></a>
                                <div class="row mt-10">
                                  <div class="col-12"><span class="calendar-icon color-gray-700 text-sm mr-20">29 May 2022</span><span class="color-gray-700 text-sm timeread">3 mins read</span></div>
                                </div>
                              </div>
                          ...
                          <div class="col-lg-12">
                            <div class="card-list-posts card-list-posts-small mb-30 wow animate__animated animate__fadeIn" data-wow-delay="0.3s">
                              <div class="card-image hover-up"><a href="single-sidebar.html"><img src="assets/imgs/page/homepage4/img3.png" alt="Genz"></a></div>
                              <div class="card-info"><a class="btn btn-tag bg-gray-800 hover-up mb-10 text-xs" href="blog-archive.html">Working Tips</a><a href="single-sidebar.html">
                                  <h5 class="mb-10 color-white">2019 Best Cars for the Money</h5></a>
                                <div class="row mt-10">
                                  <div class="col-12"><span class="calendar-icon color-gray-700 text-sm mr-20">29 May 2022</span><span class="color-gray-700 text-sm timeread">3 mins read</span></div>
                                </div>
                              </div>
                          ...
                          <div class="col-lg-12">
                            <div class="card-list-posts card-list-posts-small mb-30 wow animate__animated animate__fadeIn" data-wow-delay="0.4s">
                              <div class="card-image hover-up"><a href="single-sidebar.html"><img src="assets/imgs/page/homepage4/img4.png" alt="Genz"></a></div>
                              <div class="card-info"><a class="btn btn-tag bg-gray-800 hover-up mb-10 text-xs" href="blog-archive.html">Working Tips</a><a href="single-sidebar.html">
                                  <h5 class="mb-10 color-white">How to View Breast Cancer Survival Rates</h5></a>
                                <div class="row mt-10">
                                  <div class="col-12"><span class="calendar-icon color-gray-700 text-sm mr-20">29 May 2022</span><span class="color-gray-700 text-sm timeread">3 mins read</span></div>
                                </div>
                              </div>
              ...
              <div class="row mt-70 mb-50">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6">
                  <div class="card-style-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
                    <div class="card-image"><a href="blog-archive.html"><img src="assets/imgs/page/homepage1/tag6.png" alt="Genz"></a></div>
                    <div class="card-info"><a class="color-gray-500" href="blog-archive.html">Space</a></div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6">
                  <div class="card-style-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay="0.1s">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6">
                  <div class="card-style-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
                    <div class="card-image"><a href="blog-archive.html"><img src="assets/imgs/page/homepage1/tag11.png" alt="Genz"></a></div>
                    <div class="card-info"><a class="color-gray-500" href="blog-archive.html">Nature</a></div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6">
                  <div class="card-style-2 hover-up hover-neon wow animate__animated animate__fadeIn" data-wow-delay="0.6s">
                    <div class="card-image"><a href="blog-archive.html"><img src="assets/imgs/page/homepage1/tag12.png" alt="Genz"></a></div>
              ...
              <div class="row mt-70">
                <div class="col-lg-6 wow animate__animated animate__fadeIn">
                  <div class="card-blog-1 hover-up">
                    <div class="card-image mb-20"><a class="post-type" href="blog-archive.html"></a><a href="single-sidebar.html"><img src="assets/imgs/page/homepage1/news2.png" alt="Genz"></a></div>
                    <div class="card-info">
                      <div class="row">
                        <div class="col-7"><a class="color-gray-700 text-sm" href="blog-archive.html"> #Travel</a><a class="color-gray-700 text-sm" href="blog-archive.html"> #Lifestyle</a>
                        </div>
                      ...
                      <div class="row align-items-center mt-25">
                        <div class="col-7">
                          <div class="box-author"><img src="assets/imgs/page/homepage1/author.png" alt="Genz">
                            <div class="author-info">
                ...
                <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                  <div class="card-blog-1 hover-up">
                    ...
                    <div class="card-info">
                      ...
                      <div class="row align-items-center mt-25">
                        <div class="col-7">
                          <div class="box-author"><img src="assets/imgs/page/homepage1/author2.png" alt="Genz">
                            <div class="author-info">
              ...
              <div class="text-center mb-80 mt-50 wow animate__animated animate__pulse"><img src="assets/imgs/page/homepage4/banner-3.png" alt="Genz"></div>
              <div class="row">
                <div class="col-lg-12"> 
                  <div class="row"> 
                    <div class="col-lg-4">
                  ...
                  <div class="row">
                    <div class="swiper-container swiper-group-1">
                      <div class="swiper-wrapper wow animate__animated animate__fadeIn">
                        <div class="swiper-slide"><a href="#"><img src="assets/imgs/page/homepage3/agon.svg" alt="Genz"></a></div>
                        <div class="swiper-slide"><a href="#"><img src="assets/imgs/page/homepage3/mon.svg" alt="Genz"></a></div>
                        <div class="swiper-slide"><a href="#"><img src="assets/imgs/page/homepage3/fig.svg" alt="Genz"></a></div>
                        <div class="swiper-slide"><a href="#"><img src="assets/imgs/page/homepage3/flow.svg" alt="Genz"></a></div>
                        <div class="swiper-slide"><a href="#"><img src="assets/imgs/page/homepage3/evara.svg" alt="Genz"></a></div>
                      </div>
                    </div>
                  </div>
                </div>
